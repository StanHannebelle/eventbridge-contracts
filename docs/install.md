...
- Search and replace "eventbridge-contracts" and replace it with the same project name
- Rename the `eventbridge-contracts.code-workspace` file at the root of the project to `<projectName>.code-workspace`
...
- Open a terminal and run: `aws configure --profile <your-profile>` (the value of `<your-profile>` depends of your choice in [the personalization section](#change-the-project-general-settings). By default it will be `eventbridge-contracts-developer`);
